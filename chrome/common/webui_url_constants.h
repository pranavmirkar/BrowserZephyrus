...
// Zephyrus Privacy Intelligence diagnostics (spec 11.1). Counters only.
inline constexpr char kChromeUIZephyrusPrivacyInternalsHost[] =
    "privacy-internals";
// The user-facing Privacy Intelligence dashboard (spec 6.4, 6.7). Separate
// host from the diagnostics page above BECAUSE this one names sites and
// companies and that one must never do so (spec 13.4).
inline constexpr char kChromeUIZephyrusPrivacyHost[] = "privacy";
