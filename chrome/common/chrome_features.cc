...
// Chrome versions.
// Zephyrus: Glic (Gemini in Chrome) force-disabled everywhere — no AI.
...
// possible.
// Zephyrus: enabled — HTTP navigations are upgraded/warned by default (the
// balanced mode doesn't warn where HTTPS can't reasonably be expected), giving
// an HTTPS-first posture out of the box.
