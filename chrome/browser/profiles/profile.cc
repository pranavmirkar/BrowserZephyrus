...
void Profile::RegisterProfilePrefs(user_prefs::PrefRegistrySyncable* registry) {
  // Zephyrus: search suggestions ON by default (user preference) so the omnibox
  // shows useful as-you-type suggestions. (Sends keystrokes to the default
  // search engine; users who prefer privacy can turn it off in settings.)
