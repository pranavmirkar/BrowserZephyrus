...
void RegisterPredictionOptionsProfilePrefs(
  ...
  // Zephyrus: preloading speculatively preconnects/prefetches/prerenders pages
  // (whole hidden renderer processes) before you click. Off by default — a big
  // idle-RAM and network win, and preconnects leak browsing intent. Users can
  // re-enable it under Settings > Performance > Preload pages.
