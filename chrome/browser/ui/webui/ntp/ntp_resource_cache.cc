...
void NTPResourceCache::CreateNewTabIncognitoHTML(
  ...
  // Zephyrus: rebranded, localized Private Workspace strings for the new tab
  // page. The <title> feeds the tab/sidebar label; the rest fill the page.
  replacements["title"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_NEW_PRIVATE_TAB);
  replacements["zephyrusPwHeading"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_HEADING);
  replacements["zephyrusPwDescription"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_DESCRIPTION);
  replacements["zephyrusPwWontKeepTitle"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_WONT_KEEP_TITLE);
  replacements["zephyrusPwKeepHistory"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_KEEP_HISTORY);
  replacements["zephyrusPwKeepCookies"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_KEEP_COOKIES);
  replacements["zephyrusPwKeepForms"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_KEEP_FORMS);
  replacements["zephyrusPwKeepPermissions"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_KEEP_PERMISSIONS);
  replacements["zephyrusPwSeeTitle"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_SEE_TITLE);
  replacements["zephyrusPwSeeWebsites"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_SEE_WEBSITES);
  replacements["zephyrusPwSeeEmployer"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_SEE_EMPLOYER);
  replacements["zephyrusPwSeeIsp"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_SEE_ISP);
  replacements["zephyrusPwCookieTitle"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_COOKIE_TITLE);
  replacements["zephyrusPwCookieBody"] =
      l10n_util::GetStringUTF8(IDS_ZEPHYRUS_PW_NTP_COOKIE_BODY);
