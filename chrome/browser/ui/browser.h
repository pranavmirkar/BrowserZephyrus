...
class Browser : public TabStripModelObserver,
 ...
 private:
  ...
  // Zephyrus: set once the window is genuinely closing, so that emptying the
  // tab strip on the way out still closes it. See TabStripEmpty().
  bool zephyrus_window_closing_ = false;
