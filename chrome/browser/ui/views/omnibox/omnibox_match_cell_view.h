...
class OmniboxMatchCellView : public views::View {
 ...
 public:
  ...
  // Zephyrus: a row carrying a title over its URL. See ZephyrusIsTwoLine().
  static constexpr int kZephyrusTwoLineRowHeight = 56;
 ...
 private:
  ...
  // Whether this row stacks its title over its URL. See the definition.
  bool ZephyrusIsTwoLine() const;
