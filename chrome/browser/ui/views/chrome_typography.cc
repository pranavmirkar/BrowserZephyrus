...
void ApplyCommonFontStyles(int context,
  ...
  switch (context) {
    ...
    case CONTEXT_OMNIBOX_TOOLBELT_BUTTON: {
      ...
      // Zephyrus (Figma searchbar_resultdropdown): the search bar and result
      // rows use 12px text (13px on touch), smaller than Chrome's default.
      int desired_font_size = is_touch_ui ? 13 : 12;
