...
class MultiContentsResizeArea : public views::ResizeArea {
 ...
 public:
  // Zephyrus: 4, not 6. With the panes no longer adding their own margins on
  // the facing edges, this IS the gutter -- and 4 + 4 makes it exactly the
  // 8px gap the content card keeps against everything else.
  static constexpr int kHandleResizeAxisPadding = 4;
