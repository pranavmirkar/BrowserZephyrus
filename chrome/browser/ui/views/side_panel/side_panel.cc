...
int GetBorderThickness() {
  // Zephyrus: 6, matching Helium.
  //
  // This is the padding INSIDE the panel, and it is what makes the section
  // cards read as cards -- they float on the panel's own background with an
  // even margin all round. Upstream's 8-plus-separator is tuned for a browser
  // whose page is flush to the window; beside a floating content card it reads
  // as slack rather than as a frame.
  //
  // The panel is NOT given a surface of its own. That was tried and it was
  // wrong: the cards inside it are the surfaces, and a second one behind them
  // just flattens the whole column into one slab.
  return 6;
}
