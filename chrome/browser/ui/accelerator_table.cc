...
//      global_keyboard_shortcuts_mac.mm.
    ...
    // Zephyrus: workspace switching. Ctrl+Shift+Down/Up cycle next/previous,
    // Ctrl+Shift+1..8 jump directly to a workspace by position. (Ctrl+Alt combos
    // are reserved by Windows / AltGr, so Ctrl+Shift is used instead.)
    {ui::VKEY_DOWN, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN,
     IDC_ZEPHYRUS_WORKSPACE_NEXT},
    {ui::VKEY_UP, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN,
     IDC_ZEPHYRUS_WORKSPACE_PREV},
    {ui::VKEY_1, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN,
     IDC_ZEPHYRUS_WORKSPACE_1},
    {ui::VKEY_2, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN,
     IDC_ZEPHYRUS_WORKSPACE_2},
    {ui::VKEY_3, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN,
     IDC_ZEPHYRUS_WORKSPACE_3},
    {ui::VKEY_4, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN,
     IDC_ZEPHYRUS_WORKSPACE_4},
    {ui::VKEY_5, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN,
     IDC_ZEPHYRUS_WORKSPACE_5},
    {ui::VKEY_6, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN,
     IDC_ZEPHYRUS_WORKSPACE_6},
    {ui::VKEY_7, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN,
     IDC_ZEPHYRUS_WORKSPACE_7},
    {ui::VKEY_8, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN,
     IDC_ZEPHYRUS_WORKSPACE_8},
