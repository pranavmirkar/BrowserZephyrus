...
<if expr="not is_chromeos">
      ...
      <div class="secondary">$i18n{aboutZephyrusVersion}</div>
...
<settings-section>
  <div class="info-sections">
    <div class="info-section">
      ...
      <div class="secondary">$i18nRaw{aboutZephyrusCompany}</div>
    </div>

    <div class="info-section">
      <div class="secondary">$i18nRaw{aboutZephyrusChromiumCredit}</div>
