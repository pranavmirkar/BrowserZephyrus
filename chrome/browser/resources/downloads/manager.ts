...
export class DownloadsManagerElement extends DownloadsManagerElementBase {
  ...
  private addThemedColors_() {
    ...
    link.rel = 'stylesheet';
    // Zephyrus: plus the M3 roles Chromium's sys set lacks (the surface
    // containers, outline-variant), which the M3 styling reads.
    link.href = 'chrome://theme/colors.css?sets=ui,chrome,zephyrus';
