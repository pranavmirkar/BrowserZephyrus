...
auto RunZephyrusAgentKernelService(
    mojo::PendingReceiver<zephyrus::agent::mojom::AgentKernel> receiver) {
  return std::make_unique<zephyrus::agent::AgentKernelService>(
      std::move(receiver));
}
#endif
...
void RegisterMainThreadServices(mojo::ServiceFactory& services) {
  ...
  services.Add(RunZephyrusAgentKernelService);
#endif  // !BUILDFLAG(IS_ANDROID)
