...
export class CrProgressElement extends CrLitElement {
  ...
  override updated(changedProperties: PropertyValues<this>) {
    ...
    if (changedProperties.has('min') || changedProperties.has('max') ||
      ...
      // Zephyrus: the [wavy] indicator cannot be scaled -- scaling squashes
      // the wave with the value -- so it clips to this instead.
      this.style.setProperty('--cr-progress-ratio', ratio.toString());
