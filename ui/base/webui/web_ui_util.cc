...
std::string GetFontFamily() {
  ...
  // Zephyrus: Inter leads every WebUI page's font stack (settings, history,
  // downloads, extensions, ...), matching the native-UI override in
  // chrome_browser_main_win.cc. The locale stack remains as fallback.
