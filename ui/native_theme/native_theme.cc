...
void NativeTheme::PaintMenuItemBackground(
  ...
  // Antialias the rounded corners. PaintFlags defaults to aliased drawing,
  // which is invisible upstream because the default corner_radius is 0 — square
  // edges need no smoothing. Zephyrus rounds the menu highlight (radius 5), and
  // without this every corner is a hard staircase.
