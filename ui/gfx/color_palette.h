...
// Zephyrus: re-hued from Google Blue to Pomegranate, each stop keeping its
// original L*. This ramp is the FALLBACK path -- older views and cr_elements
// components reach for it directly when no ColorProvider token applies, so
// leaving it blue left Google blue showing through a themed browser. See the
// matching note in cr_elements/cr_shared_vars.css.
constexpr SkColor kGoogleBlue050 = SkColorSetRGB(0xFF, 0xEB, 0xE9);
constexpr SkColor kGoogleBlue100 = SkColorSetRGB(0xFF, 0xD9, 0xD5);
constexpr SkColor kGoogleBlue200 = SkColorSetRGB(0xFE, 0xB8, 0xB2);
constexpr SkColor kGoogleBlue300 = SkColorSetRGB(0xFF, 0x95, 0x8F);
constexpr SkColor kGoogleBlue400 = SkColorSetRGB(0xFA, 0x73, 0x6F);
constexpr SkColor kGoogleBlue500 = SkColorSetRGB(0xF3, 0x49, 0x4F);
constexpr SkColor kGoogleBlue600 = SkColorSetRGB(0xDF, 0x32, 0x3F);
constexpr SkColor kGoogleBlue700 = SkColorSetRGB(0xCE, 0x21, 0x35);
constexpr SkColor kGoogleBlue800 = SkColorSetRGB(0xB9, 0x18, 0x2D);
constexpr SkColor kGoogleBlue900 = SkColorSetRGB(0xA3, 0x12, 0x26);
