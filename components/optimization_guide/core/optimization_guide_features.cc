...
// Zephyrus: master AI backend gateway — force-disabled to strip AI (Compose,
// tab organization, history-embeddings answers, etc. all gate on this) and to
// prevent any on-device/optimization-guide model execution.
BASE_FEATURE(kOptimizationGuideModelExecution,
             base::FEATURE_DISABLED_BY_DEFAULT);

// Whether to use the on device model service in optimization guide.
// Zephyrus: force-disabled everywhere so the on-device AI model is never
// downloaded or run.
