...
// Zephyrus: controls the periodic fetch of the supported-language roster from
// translate.googleapis.com. Disabled by default -- see translate_features.cc.
BASE_DECLARE_FEATURE(kTranslateLanguageListFetch);
