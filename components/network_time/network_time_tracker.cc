...
// Zephyrus: network time queries hit a Google time server in the background.
// Disabled everywhere — the OS clock is authoritative, and this removes both a
// periodic background fetch (RAM/network) and a phone-home surface.
